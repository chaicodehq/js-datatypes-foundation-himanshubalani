...
export function createPaanOrder(basePaan, customizations) {
  ...
  let ep = Object.assign({}, basePaan)
  if (typeof customizations != "object") return ep
...
export function updatePrices(menu, increase) {
  ...
  for (const [item, price] of menuArr) {
    menuMap.set(item, price+increase);
  }
   return Object.fromEntries(menuMap);
}
